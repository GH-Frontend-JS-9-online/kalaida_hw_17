        ...
        <header className="messagesHeader">
          <div className="messagesHeader_container">
            ...
            <div className="messagesHeader_right">
              <a href="#" className="messagesHeader_right-btn">Add <span> +</span></a>
              <a href="#" className="messagesHeader_right-search"><i className="fa fa-search" aria-hidden="true"></i></a>
              <a href="#" className="messagesHeader_right-notifications"><i className="fa fa-bell-o" aria-hidden="true"></i></a>
              <a href="#" className="messagesHeader_right-profile">
        ...
        <main className="mainMessages">
          <div className="mainMessages_sidebar">
            <div className="mainMessages_sidebar_links">
              <a href="#" className="mainMessages_sidebar-link"><i className="fa fa-home" aria-hidden="true"></i></a>
              <a href="#" className="mainMessages_sidebar-link"><i className="fa fa-bars" aria-hidden="true"></i></a>
              <a href="#" className="mainMessages_sidebar-link"><i className="fa fa-line-chart" aria-hidden="true"></i></a>
              <a href="#" className="mainMessages_sidebar-linkActive"><i className="fa fa-envelope"
                                                                         aria-hidden="true"></i></a>
              <a href="#" className="mainMessages_sidebar-link"><i className="fa fa-users" aria-hidden="true"></i></a>
            </div>
          </div>
          <div className="mainMessages_content">
            <div className="mainMessages_bar">
              <div className="mainMessages_bar_left">
                <div className="mainMessages_bar_links">
                  <a href="#" className="mainMessages_bar-link"><i className="fa fa-inbox" aria-hidden="true"></i> Inbox</a>
                  <a href="#" className="mainMessages_bar-link"><i className="fa fa-paper-plane" aria-hidden="true"></i> Sent</a>
                  <a href="#" className="mainMessages_bar-link"><i className="fa fa-trash" aria-hidden="true"></i> Trash</a>
                </div>
              </div>
            ...
            <div className="mainMessages_bottom">
              <div className="conversations">
                <a href="#" className="conversations-btn" id="newConversationBtn"><span>+</span> New Conversation</a>
              </div>
